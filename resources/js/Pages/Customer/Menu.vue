                        ...
                        <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                            ...
                            <div class="relative group border-b-2 border-transparent hover:border-gray-300">
                              ...
                              <div
                                  ...
                                  <DropdownLink @click="scrollToCategory(category.name)" href="#Holiday Limited Edition">Holiday Limited Edition</DropdownLink>
                                  <DropdownLink href="#Coffee Beverage">Latte</DropdownLink>
                                  <DropdownLink href="#Foods & Snacks">Cold</DropdownLink>
                                  <DropdownLink href="#Coffee Beans & Ground Coffee">Premium Roast</DropdownLink>
                              </div>
                            </div>
      ...
      <section v-if="searchResults.length" class="mt-6 px-6">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          <div 
            ...
            :style="product.category_id === 1 ? { backgroundImage: 'url(images/left.gif)' } : {}"
            >
      ...
      <section class="px-6 py-10 space-y-10">
        <div v-for="category in props.category"
          ...
          <div class="mt-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            <div 
              v-for="product in products.filter(product => product.category_id === category.id && product.availability)" 
              :key="product.id" 
              :class="{
                'bg-gray-100': product.category_id !== 1,
                'bg-cover bg-center': product.category_id === 1
